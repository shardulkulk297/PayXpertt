...
//        }
        ...
        System.out.println("17. Get Financiial Record for Specific Date");
        ...
        switch(option){
            ...
            case 6->{
                ...
                try{
                    pay.GeneratePayroll(empId, startDate, endDate);
                }
            ...
            case 8->{
                ...
                PayrollService pay = new PayrollService();
                try{
                    pay.GetPayrollsForEmployee(empId);
                }
                catch(PayrollGenerationException e){
                    e.printStackTrace();
            ...
            case 9->{
                ...
                PayrollService pay = new PayrollService();
                try{
                    pay.GetPayrollsForPeriod(startDate, endDate);
                }
                catch(PayrollGenerationException e){
                    e.printStackTrace();
